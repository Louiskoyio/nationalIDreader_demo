package com.louiskoyio.nationalidreader.faceDetection;
...
import com.louiskoyio.nationalidreader.utilities.FrameMetadata;
...
public interface VisionImageProcessor {
    ...
    void processByteBuffer(
            byte[] byteArray, FrameMetadata frameMetadata)
            throws MlKitException;
