        ...
        View.OnTouchListener
{
    ...
    private CameraActivityInterface mCameraActivityInterface;
    ...
    private RelativeLayout mStillshotContainer, mFlashContainer, mSwitchOrientationContainer,
            ...
            mSaveContainer, mTrashContainer;
    ...
    public void onViewCreated(@NonNull View view, @NonNull Bundle savedInstanceState) {
        ...
        findCameraIds();
        mCameraId = mCameraActivityInterface.getBackCameraId();
        mCameraActivityInterface.setCameraBackFacing();
        setMaxSizes();
    ...
    private void hideStillshotContainer(){
        mCameraActivityInterface.showStatusBar();
        if(mIsImageAvailable){
    ...
    private void takePicture()  {
        ...
        mProgressDialog.setMessage("Preparing Image. Please wait ...");
    ...
    public void onResume() {
        ...
        if(mIsImageAvailable){
            mCameraActivityInterface.hideStatusBar();
        }
        else{
            mCameraActivityInterface.showStatusBar();
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            ErrorDialog.newInstance("Not supported.")
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (facing == CameraCharacteristics.LENS_FACING_FRONT){
                    mCameraActivityInterface.setFrontCameraId(cameraId);
                }
                else if (facing == CameraCharacteristics.LENS_FACING_BACK){
                    mCameraActivityInterface.setBackCameraId(cameraId);
                }
            }
            mCameraActivityInterface.setCameraFrontFacing();
            mCameraId = mCameraActivityInterface.getFrontCameraId();
        } catch (CameraAccessException e) {
            e.printStackTrace();
        }
    }
    ...
    private void toggleCameraDisplayOrientation(){
        if(mCameraId.equals(mCameraActivityInterface.getBackCameraId())){
            mCameraId = mCameraActivityInterface.getFrontCameraId();
            mCameraActivityInterface.setCameraFrontFacing();
            closeCamera();
            reopenCamera();
        ...
        else if(mCameraId.equals(mCameraActivityInterface.getFrontCameraId())){
            mCameraId = mCameraActivityInterface.getBackCameraId();
            mCameraActivityInterface.setCameraBackFacing();
            closeCamera();
            reopenCamera();
    ...
    private static class ImageSaver implements Runnable {
        ...
        ImageSaver(Bitmap bitmap, File file, CallbackInterface callback) {
            mBitmap = bitmap;
            mFile = file;
            mCallback = callback;
        }

        ImageSaver(Image image, File file, CallbackInterface callback) {
            mImage = image;
            mFile = file;
            mCallback = callback;
        }
    ...
    public void onAttach(Context context) {
        ...
        try{
            mCameraActivityInterface = (CameraActivityInterface) getActivity();
    ...
    public static class ConfirmationDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage("Permission to take photos?")
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
